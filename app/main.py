...
app.include_router(
    api__item_category.router,
    prefix="/api/item_categories",
    tags=["API: item categories"],
)
app.include_router(
    api__item_with_category.router,
    prefix="/api/item_with_categories",
    tags=["API: items with categories"],
)
