...
@router.get("/", response_model=list[schemas.ItemWithCategory])
...
@router.put("/{item_with_category_id}", response_model=schemas.ItemWithCategory)
...
@router.delete("/{item_with_category_id}", response_model=schemas.ItemWithCategory)
